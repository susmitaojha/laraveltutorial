                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        ...
                        <li>
                            <a href="#">
                                <div>
                                    <strong><span class=" label label-success">{{ Auth::user() -> name }}</span></strong>
                                    <span class="pull-right text-muted">
                                        <em>Yesterday</em>
                                    </span>
                                </div>
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{ url('flot_page') }}">Flot Charts</a>
                            </li>
                            <li>
                                <a href="{{ url('add_datapost') }}">Add Data</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>Address Customer<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{ route('AddressController.add') }}">Add Address</a>
                            </li>
                            <li>
                                <a href="{{ route('AddressController.list') }}">Address list</a>
                            </li>
                        </ul>
                        <!-- second-level-items -->
                    </li>
